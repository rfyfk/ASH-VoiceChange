...
from separator.uvr_lib_v5.stft import STFT
...
class MDXSeparator(CommonSeparator):
    ...
    def __init__(self, common_config, arch_config):
        ...
        # In UVR, these variables are set but either aren't useful or are better handled in VoiceChange.
        # Leaving these comments explaining to help myself or future developers understand why these aren't in VoiceChange.
