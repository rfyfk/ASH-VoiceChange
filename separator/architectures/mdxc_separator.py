...
from separator.common_separator import CommonSeparator
from separator.uvr_lib_v5 import spec_utils
from separator.uvr_lib_v5.tfc_tdf_v3 import TFC_TDF_net
from separator.uvr_lib_v5.roformer.mel_band_roformer import MelBandRoformer
from separator.uvr_lib_v5.roformer.bs_roformer import BSRoformer
...
class MDXCSeparator(CommonSeparator):
    ...
    def load_model(self):
        ...
        try:
            ...
            self.logger.error(f"Please try deleting the model file from {self.model_path} and run VoiceChange again to re-download it.")
            sys.exit(1)
